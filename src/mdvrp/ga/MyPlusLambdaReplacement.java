...
public class MyPlusLambdaReplacement implements SurvivorSelector<PopulationMDVRP, ChromosomeMDVRP> {
    ...
    public PopulationMDVRP select(PopulationMDVRP generation, List<ChromosomeMDVRP> parents, List<ChromosomeMDVRP> offspring) {
        ...
        myPlusLa.sort(UtilChromosomeMDVRP.chromosomeFitnessComparator());
        return new PopulationMDVRP(myPlusLa.subList(0, generation.getSize()), generation.getSwappingMap());
    }
}
